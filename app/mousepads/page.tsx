        ...
        <main className="flex-1 min-w-0">
          ...
          {filtered.length === 0 ? (
            <div className="text-center py-20 text-gray-500">
              <p>条件に一致するマウスパッドが見つかりません</p>
              <button onClick={() => { setMaxPrice(20000); setSize("all"); setSurface("all"); setMaterial("all"); setTag("all"); setStitchedOnly(false); setRgbOnly(false); setSearch(""); }}
